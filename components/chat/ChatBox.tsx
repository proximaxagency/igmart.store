...
export function ChatBox({ conversationId, onBack, compact = false }: ChatBoxProps) {
  ...
  const handleSendCredentials = async () => {
    ...
    try {
      await sendMessage({
        conversationId,
        content: "ðŸ” Automated Encrypted Credential Vault Delivered",
                  ...
                  <div className="space-y-2 text-xs font-mono">
                    <div className="bg-background/80 border border-border rounded-lg p-2.5 flex items-center justify-between">
                      <div>
                        ...
                        <span className="text-text font-bold">{isRevealed ? login : "â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"}</span>
                      </div>
                      <button
                    ...
                    <div className="bg-background/80 border border-border rounded-lg p-2.5 flex items-center justify-between">
                      <div>
                        ...
                        <span className="text-text font-bold">{isRevealed ? password : "â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"}</span>
                      </div>
                      <button
                    ...
                    {emailPass && (
                      <div className="bg-background/80 border border-border rounded-lg p-2.5 flex items-center justify-between">
                        <div>
                          ...
                          <span className="text-text font-bold">{isRevealed ? emailPass : "â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"}</span>
                        </div>
                        <button
